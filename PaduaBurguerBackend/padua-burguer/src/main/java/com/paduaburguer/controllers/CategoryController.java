...
public class CategoryController {
	...
	@Operation(summary = "Adds a new Category", description = "Adds a new Category by passing in a JSON or XML representation of the category",
		tags = {"Category"},
		responses = {
		@ApiResponse(description = "Success", responseCode = "200", 
				content = @Content(schema = @Schema(implementation = CategoryDTO.class))
	...
	@Operation(summary = "Updates a Category", description = "Updates a Category by passing in a JSON or XML representation of the category",
		tags = {"Category"},
		responses = {
				@ApiResponse(description = "Success", responseCode = "200", 
					content = @Content(schema = @Schema(implementation = CategoryDTO.class))
	...
	@Operation(summary = "Deletes a Category", description = "Updates a Category by passing in a JSON or XML representation of the category",
		tags = {"Category"},
		responses = {
				@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
				@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
